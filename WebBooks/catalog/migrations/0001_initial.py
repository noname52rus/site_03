    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(help_text='Введите Имя автора', max_length=120, verbose_name='Имя автора')),
                ('last_name', models.CharField(help_text='Введите Фамилию автора', max_length=120, verbose_name='Фамилия автора')),
